...
namespace PharMind.API.Migrations
{
    ...
    [Migration("20251106135251_AddProcessLogTable")]
    partial class AddProcessLogTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PharMind.API.Models.AuditCategory", b =>
                {
                    ...
                    b.Property<string>("CdgCategoria")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("PharMind.API.Models.AuditMarketMarca", b =>
                {
                    ...
                    b.Property<string>("CdgLaboratorio")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("CdgMarca")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("PharMind.API.Models.AuditProductClass", b =>
                {
                    ...
                    b.Property<string>("CdgClaseProducto")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("PharMind.API.Models.Agente", b =>
                {
                    ...
                    b.HasOne("PharMind.API.Models.EntidadDinamica", "DatosExtendidos")
                        .WithMany()
                    ...
                    b.HasOne("PharMind.API.Models.EsquemaPersonalizado", "TipoAgente")
                        .WithMany()
            ...
            modelBuilder.Entity("PharMind.API.Models.Cliente", b =>
                {
                    ...
                    b.HasOne("PharMind.API.Models.EsquemaPersonalizado", "TipoCliente")
                        .WithMany()
            ...
            modelBuilder.Entity("PharMind.API.Models.Interaccion", b =>
                {
                    ...
                    b.HasOne("PharMind.API.Models.EsquemaPersonalizado", "TipoInteraccionEsquema")
                        .WithMany()
            ...
            modelBuilder.Entity("PharMind.API.Models.Relacion", b =>
                {
                    ...
                    b.HasOne("PharMind.API.Models.EsquemaPersonalizado", "TipoRelacionEsquema")
                        .WithMany()
